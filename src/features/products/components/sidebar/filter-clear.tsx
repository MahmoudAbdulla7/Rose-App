...
export default function FilterClear({ ...props }: HoveredLinkProps & { text: string }) {
  return (
    <HoveredLink
      {...props}
      className="focus-visible:ring-ds-ring inline-flex items-center gap-1 text-sm text-red-600 transition-colors duration-200 ease-out hover:text-red-700 focus-visible:ring-2 focus-visible:outline-none dark:text-red-400 dark:hover:text-red-300"
    >
